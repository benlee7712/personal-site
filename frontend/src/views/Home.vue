        ...
        <full-page>
            <div class="section section-1 h-screen">
                <div class="w-full flex fade-slide-in-top">
                    <h2 class="mt-[50vh] translate-y-[-50%] py-1 mx-[10%] sm:mx-[10%] font-open text-3xl sm:text-4xl lg:text-5xl 2xl:text-6xl text-slate text-left align-middle corner-borders-coral leading-normal">
